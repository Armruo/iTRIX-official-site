            ...
            <form className="mx-auto max-w-[440px]">
              <div className="flex gap-3">
                <input
                  ...
                  aria-label="Email"
                />
                <button className="btn group w-full flex-1 bg-gradient-to-t from-indigo-600 to-indigo-500 bg-[length:100%_100%] bg-[bottom] text-white shadow-[inset_0px_1px_0px_0px_theme(colors.white/.16)] hover:bg-[length:100%_150%]">
