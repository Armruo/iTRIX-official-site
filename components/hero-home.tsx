import VideoThumb from "@/public/images/hero-image-0307-1.png";
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="pb-12 text-center md:pb-20">
            ...
            <h1
              ...
              bg-[linear-gradient(to_right,theme(colors.gray.200),theme(colors.indigo.200),theme(colors.gray.50),theme(colors.indigo.300),theme(colors.gray.200))] bg-[length:200%_auto] 
              bg-clip-text pb-5 
